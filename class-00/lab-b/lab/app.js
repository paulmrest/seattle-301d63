...
let sumAndProduct = (a, b) => new Array(a + b, a * b);
...
// I'm honestly not quite sure what's going on here. joe.scope() is an instance method of the Student object, so the
// "console.log(this)" on line 221 is referring to the object itself, which we can see in the console output. However,
// trying to console.log the method invocation gives an "undefined" in the console. I know JS applies a toString
// method to anything in a console. method, so maybe it just doesn't know how to convert a function invocation.
// I dug around online looking for an answer to this, but couldn't find much.

// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" in the "joe.scopeArrow()" "method" is the window. "this" has no context other than the overall scope of the code;
// it isn't bound to anything, and so it is the same as calling referring to "this" in a non-instance method or outside of
// a constructor.
